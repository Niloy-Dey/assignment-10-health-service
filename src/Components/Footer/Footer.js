...
const Footer = () => {
    return (
        <div className="bg-dark pt-5 m-0 pb-1 footer-style">
            <Container>
                <footer>
                    <Row xs={1} md={4} className="g-4">
                        ...
                        <Col className="text-white text-start">
                            <h4 className="pb-3 m-logo" >Health services </h4>
                            <div>
                    ...
                    <h6 className="text-muted pt-5 pb-1">Copyright &copy; 2021 Health services</h6>
                </footer>
            </Container>
        </div >
    );
